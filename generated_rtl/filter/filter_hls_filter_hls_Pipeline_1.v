...
module filter_hls_filter_hls_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] gmem0_addr_read_reg_149;
reg    ap_block_pp0_stage0_01001_grp1;
reg   [19:0] loop_index52_fu_54;
wire   [19:0] empty_fu_105_p2;
wire    ap_loop_init;
reg   [19:0] ap_sig_allocacmp_loop_index52_load;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond12_fu_99_p2 == 1'd0))) begin
            loop_index52_fu_54 <= empty_fu_105_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index52_fu_54 <= 20'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001_grp1))) begin
        gmem0_addr_read_reg_149 <= m_axi_gmem0_0_RDATA;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond12_fu_99_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_sig_allocacmp_loop_index52_load = 20'd0;
    end else begin
        ap_sig_allocacmp_loop_index52_load = loop_index52_fu_54;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_gmem1_0_WREADY == 1'b0)) | ((m_axi_gmem0_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_gmem1_0_WREADY == 1'b0)) | ((m_axi_gmem0_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (m_axi_gmem1_0_WREADY == 1'b0)) | ((m_axi_gmem0_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign empty_fu_105_p2 = (ap_sig_allocacmp_loop_index52_load + 20'd1);

assign exitcond12_fu_99_p2 = ((ap_sig_allocacmp_loop_index52_load == 20'd921600) ? 1'b1 : 1'b0);
...
assign m_axi_gmem1_0_WDATA = gmem0_addr_read_reg_149;
...
endmodule //filter_hls_filter_hls_Pipeline_1
