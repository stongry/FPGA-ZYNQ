...
module filter_hls_filter_hls_Pipeline_16 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond11517_fu_101_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond11517_fu_101_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_fu_58 <= empty_fu_107_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_58 <= 11'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond11517_fu_101_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign empty_fu_107_p2 = (ap_sig_allocacmp_loop_index_load + 11'd1);

assign exitcond11517_fu_101_p2 = ((ap_sig_allocacmp_loop_index_load == 11'd1280) ? 1'b1 : 1'b0);

assign loop_index_cast_fu_113_p1 = ap_sig_allocacmp_loop_index_load;
...
assign row_buf_address0 = loop_index_cast_fu_113_p1;

assign row_buf_ce0 = row_buf_ce0_local;

endmodule //filter_hls_filter_hls_Pipeline_16
