...
module filter_hls_filter_hls_Pipeline_11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond11719_fu_96_p2;
...
reg   [10:0] loop_index31_load_reg_135;
reg    ap_block_pp0_stage0_11001;
reg   [10:0] loop_index31_load_reg_135_pp0_iter1_reg;
reg   [31:0] gmem0_addr_read_reg_144;
wire   [63:0] loop_index31_cast_fu_119_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [10:0] loop_index31_fu_56;
wire   [10:0] empty_fu_102_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_loop_index31_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond11719_fu_96_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index31_fu_56 <= empty_fu_102_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index31_fu_56 <= 11'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        loop_index31_load_reg_135 <= ap_sig_allocacmp_loop_index31_load;
        loop_index31_load_reg_135_pp0_iter1_reg <= loop_index31_load_reg_135;
    end
end
...
always @ (*) begin
    if (((exitcond11719_fu_96_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index31_load = 11'd0;
    end else begin
        ap_sig_allocacmp_loop_index31_load = loop_index31_fu_56;
    end
end
...
assign empty_fu_102_p2 = (ap_sig_allocacmp_loop_index31_load + 11'd1);

assign exitcond11719_fu_96_p2 = ((ap_sig_allocacmp_loop_index31_load == 11'd1280) ? 1'b1 : 1'b0);

assign loop_index31_cast_fu_119_p1 = loop_index31_load_reg_135_pp0_iter1_reg;
...
assign row_buf_address0 = loop_index31_cast_fu_119_p1;
...
endmodule //filter_hls_filter_hls_Pipeline_11
