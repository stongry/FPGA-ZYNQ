...
module filter_hls_filter_hls_Pipeline_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond11015_fu_101_p2;
...
reg   [31:0] row_buf_load_reg_150;
wire   [63:0] loop_index46_cast_fu_113_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [10:0] loop_index46_fu_58;
wire   [10:0] empty_fu_107_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_loop_index46_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond11015_fu_101_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index46_fu_58 <= empty_fu_107_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index46_fu_58 <= 11'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        row_buf_load_reg_150 <= row_buf_q0;
    end
end

always @ (*) begin
    if (((exitcond11015_fu_101_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index46_load = 11'd0;
    end else begin
        ap_sig_allocacmp_loop_index46_load = loop_index46_fu_58;
    end
end
...
assign empty_fu_107_p2 = (ap_sig_allocacmp_loop_index46_load + 11'd1);

assign exitcond11015_fu_101_p2 = ((ap_sig_allocacmp_loop_index46_load == 11'd1280) ? 1'b1 : 1'b0);

assign loop_index46_cast_fu_113_p1 = ap_sig_allocacmp_loop_index46_load;
...
assign m_axi_gmem1_0_WDATA = row_buf_load_reg_150;
...
assign row_buf_address0 = loop_index46_cast_fu_113_p1;

assign row_buf_ce0 = row_buf_ce0_local;

endmodule //filter_hls_filter_hls_Pipeline_4
