...
module filter_hls_filter_hls_Pipeline_14 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond13222_fu_93_p2;
...
wire   [63:0] loop_index28_cast_fu_105_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [10:0] loop_index28_fu_50;
wire   [10:0] empty_fu_99_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_loop_index28_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond13222_fu_93_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index28_fu_50 <= empty_fu_99_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index28_fu_50 <= 11'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond13222_fu_93_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index28_load = 11'd0;
    end else begin
        ap_sig_allocacmp_loop_index28_load = loop_index28_fu_50;
    end
end
...
assign empty_fu_99_p2 = (ap_sig_allocacmp_loop_index28_load + 11'd1);

assign exitcond13222_fu_93_p2 = ((ap_sig_allocacmp_loop_index28_load == 11'd1280) ? 1'b1 : 1'b0);

assign loop_index28_cast_fu_105_p1 = ap_sig_allocacmp_loop_index28_load;
...
assign out_row_address0 = loop_index28_cast_fu_105_p1;

assign out_row_ce0 = out_row_ce0_local;

endmodule //filter_hls_filter_hls_Pipeline_14
